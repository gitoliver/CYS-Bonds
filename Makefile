#############################################################################
# Makefile for building: CYS-bonds
# Generated by qmake (2.01a) (Qt 4.8.7) on: Mi. Aug 2 14:36:48 2017
# Project:  CYS-bonds.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile CYS-bonds.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS)   -L/home/oliver/Programs/Cplusplus/CYS-bonds/../../gems/gmml/bin/ -lgmml 
AR            = ar cqs
RANLIB        = 
...
Makefile: CYS-bonds.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
		...
		/usr/share/qt4/mkspecs/features/lex.prf \
		/usr/share/qt4/mkspecs/features/include_source_dir.prf
	$(QMAKE) -o Makefile CYS-bonds.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/CYS-bonds1.0.0 || $(MKDIR) .tmp/CYS-bonds1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/CYS-bonds1.0.0/ && (cd `dirname .tmp/CYS-bonds1.0.0` && $(TAR) CYS-bonds1.0.0.tar CYS-bonds1.0.0 && $(COMPRESS) CYS-bonds1.0.0.tar) && $(MOVE) `dirname .tmp/CYS-bonds1.0.0`/CYS-bonds1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/CYS-bonds1.0.0
...
main.o: main.cpp /home/oliver/Programs/gems/gmml/includes/gmml.hpp \
